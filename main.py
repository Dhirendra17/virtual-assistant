## Virtual-Assistant created by Dhirendra Patil. This is Cross platform it will work on both Linux and Windows ##
import os
import platform
import smtplib, ssl
...
###############################  HELP SECTION ########################################
    if (("help" in query) or ("Help" in query) or ("how to use" in query)):
        ...
        print()
        print("  I'm DHIRENDRA PATIL. This is Cross platform it will work on  both Linux and Windows. ")
        print("  This project will be further converted to a voice based virtual assistant than typing it by incorporating some libraries.
  ")
        print()
        ...
        print()
        print(" >> Please open browser for me ")
        print(" >> I want to write a note")
        print(" >> Please open vscode for me")
        print()
...
#################  Send SMS  #######  Twilio Reference #####################
    # Download the helper library from https://www.twilio.com/docs/python/install Twilio is a cloud communications platform as a service company based in San Francisco, California. Twilio allows software developers to programmatically make and receive phone calls, send and receive text messages, and perform other communication functions using its web service APIs.
...
##################################  Credits ##########################################
    if("credits" in query or "programmer" in query or "developer" in query or "owner" in query):
        ...
        print("                           My Name is Dhirendra Patil..")
        print()
        print("                           My Email : dhirendrapatil777@gmail.com")
        print()
        print("                           My github : https://github.com/Dhirendra17/")
        print()
        print("                           My Linkedin profile : https://www.linkedin.com/in/dhirendra-patil/")
        print()
        print()